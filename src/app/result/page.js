          ...
          return (
            <div className="print-page-wrapper relative min-h-[1100px] flex flex-col justify-between bg-white border border-[#E2DDD5] rounded-xl p-12 shadow-md print-border-none print-shadow-none">
              ...
              <div className="space-y-5">
                ...
                {/* 오행 분석 결과 시각화 패널 */}
                <div className="bg-[#F9F8F6] p-4 rounded-lg border border-[#E2DDD5]/80 space-y-3 shadow-inner">
                  <div className="flex justify-between items-center border-b border-gray-200 pb-1.5">
                    <span className="text-[10.5px] font-bold text-[#A3845B] font-myeongjo">☯️ {name} 님의 사주 오행 분포 현황</span>
                    <span className="text-[9px] text-gray-400">일간(日干): {sajuInfo?.day?.stemEl} ({sajuInfo?.day?.stem})</span>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2.5">
                    ...
                    <div className="bg-emerald-50/30 p-4 rounded-lg border border-emerald-100/80 flex flex-col md:flex-row md:items-center gap-4">
                      ...
                      <div className={`md:w-3/4 space-y-1 ${blurClass}`}>
