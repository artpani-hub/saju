...
* 본 요약본은 혜안당 명리분석 시스템에 의해 계산 및 정밀 빌드되었습니다.`;
  ...
  const getTarotPrescription = (category) => {
    const prescriptions = {
      love: [
        "감정적 서두름 조율: 서둘러 흑백을 가리려 하거나 끝장 대화를 요구하는 것은 상대방의 회피 에너지를 증폭시킵니다. 한 템포 호흡을 고르고 가볍고 안부로 다가가십시오.",
        "관계 해운의 비방: 상대방과의 소통 시 차갑고 어두운 곳보다는 채광이 밝고 따뜻한 에너지가 도는 아늑한 카페나 숲길에서 대화를 나눌 때 마음속 오해가 빠르게 정화됩니다."
      ],
      job: [
        "자신감 회복 처방: 면접이나 서류 전형에서 탈락 소식이 오더라도 이는 귀하의 기량이 부족해서가 아니라 단지 조직의 기운과 맞지 않았을 뿐입니다. 귀하의 재능은 조만간 넓은 필드에서 빛을 볼 것입니다.",
        "개운의 행동 강령: 아침 햇살을 30분 이상 쬐며 본인의 이상적인 입사 프레젠테이션 모습을 뇌 속으로 시각화하십시오. 남동쪽 방향의 도서관이나 북카페가 최상의 학업 운을 유도합니다."
      ],
      career: [
        "이성적 템포 유지: 사표를 제출하고 뛰쳐나가고 싶은 충동이 들 때일수록 명확한 제안서나 헤드헌팅 루트를 확보한 후 신중히 움직여야 불리한 연봉 협상을 방지할 수 있습니다.",
        "커리어 개운 비방: 책상을 정갈히 정리하고 이력서를 노란색 테두리의 화일에 보관하거나 메탈 소재의 시계를 착용해 차분하고 이성적인 결단력을 외부에 강하게 노출시키십시오."
      ],
      business: [
        "비즈니스 리스크 방어: 계약 관계나 투자 서류를 검토할 때 뜬구름 잡는 호재 소문보다는 현재의 현금 흐름과 세무적인 리스크를 차분히 대조하는 집요함이 사업 성공률을 비약적으로 높입니다.",
        "번창의 비법 처방: 카운터나 사무실 입구에 황금색 장식품을 두거나 붉은 조명을 설치하여 고객을 유인하는 활기찬 화(火)의 생기를 불어넣고, 거래처 미팅 시 깔끔한 화이트 셔츠를 추천합니다."
      ],
      wealth: [
        "지출 파이프 정비: 새어나가는 잔잔한 고정 비용(정기 구독, 사소한 수수료)을 철저히 찾아내 차단하는 것이 재물운을 모으는 가장 빠른 첫걸음입니다.",
        "자산 보강 개운법: 침실 북쪽에 동전이나 귀금속을 보관하는 작고 어두운 금고 형태의 보석함을 배치해 재물이 밖으로 흩어지는 것을 무의식적으로 틀어쥐는 개운법을 작동시키십시오."
      ],
      move: [
        "안전 계약의 강령: 이사갈 공간의 등기부등본 확인이나 주변 소음, 누수 상태 등을 직접 발품 팔아 세세하게 살피지 않으면 차후에 사소한 분쟁으로 고생할 여지가 큽니다.",
        "이동운 개운 비방: 이사 당일 가장 먼저 솥이나 쌀독을 집안 중심부에 놓아 가택 신의 기운을 다스리고, 동쪽에 생기 있는 식물 화분을 놓아 푸른 목(木) 기운을 흡수하십시오."
      ],
      relation: [
        "상생의 거리 조율: 모든 이에게 좋은 사람이 되려 하지 마십시오. 나를 힘들게 하는 자들에게는 차분하게 경계를 긋고 '좋은 거절'의 화법을 구사할 때 인간관계 스트레스가 90% 이상 차단됩니다.",
        "관계 정화 처방: 마음이 복잡할 때는 녹색 계열의 옷을 착용하거나 친구와의 만남 시 물이 보이는 시원한 강변이나 호수 공원에서 대화할 때 막힌 감정의 응어리가 조용히 흘러갑니다."
      ],
      health: [
        "심신 바이오리듬 보강: 만성적인 피로나 두통은 뇌 속의 과부하 때문입니다. 낮 시간에 땀이 가볍게 날 정도의 반신욕이나 족욕 요법을 통해 하체의 차가운 운기를 머리 위로 순환시키십시오.",
        "수호의 건강 개운법: 침대 머리 방향을 창문이나 남쪽을 향하게 하고 수면 전 스마트폰을 머리맡에서 완전히 치워 차가운 수(水)의 숙면 정화 에너지를 취하도록 생활 패턴을 보강하십시오."
      ],
      exam: [
        "오답 노트 중심 복습: 새로운 진도를 조급하게 나가는 것보다 기출문제에서 틀렸던 실수 패턴을 모아 오답 노트로 다듬는 작업이 합격 확률을 200% 이상 견인해 줍니다.",
        "합격의 행동 요령: 시험 3일 전부터 밤늦게까지 공부하기보다 시험 시간표에 맞춰 아침 9시에 두뇌 회전이 활발하도록 바이오리듬을 맞추고, 필기 도구는 정갈한 메탈 케이스에 담아 휴대하십시오."
      ],
      general: [
        "고민의 본질 직시: 마음이 요동칠 때일수록 문제의 핵심 원인 한 가지만 종이에 적어보십시오. 걱정의 90%는 아직 일어나지 않은 상상 속의 불안일 뿐입니다.",
        "개운의 최종 처방: 가슴이 답답하고 엉켜 있을 때는 채광이 잘 드는 곳에서 기도를 하거나, 맑은 물 한 잔을 마시며 고민의 실타래가 술술 풀리는 미래의 모습을 기분 좋게 뇌 속에 주입하십시오."
      ]
    };
    return prescriptions[category] || prescriptions.general;
  };
      ...
      <>
        ...
        <div className="bg-[#F6F3EC] border border-[#E2DDD5] rounded-lg p-5 space-y-3 shadow-sm">
          ...
          <ul className="text-xs text-[#5F5F5F] leading-relaxed space-y-2 font-light">
            {getTarotPrescription(worryCategory).map((presc, pIdx) => {
