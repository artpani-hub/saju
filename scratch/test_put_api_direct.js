...
async function testPutApiDirect() {
  ...
  console.log('Testing PUT /api/admin/products directly on server process...');
  ...
  const script = `
    NODE_PATH=/tmp/saju_runtime_frontend/node_modules node -e "
      ...
      const req = http.request({
        ...
        res.on('end', () => console.log('HTTP PUT RESPONSE:', res.statusCode, body));
      });
  ...
  console.log('PUT DIRECT TEST OUTPUT:\n', out);
...
testPutApiDirect().catch(err => console.error('ERROR:', err));
