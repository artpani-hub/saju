...
async function buildWithoutTurbopack() {
  ...
  console.log('Building without turbopack in main frontend dir...');
  ...
  console.log('STANDARD WEBPACK BUILD OUTPUT:\n', out);
...
buildWithoutTurbopack().catch(err => console.error('ERROR:', err));
