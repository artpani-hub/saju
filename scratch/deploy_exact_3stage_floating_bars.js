...
async function deployExact3StageFloatingBars() {
  ...
  console.log('SFTP Uploading updated src/app/result/page.js with exact 3-stage floating bar sequence...');

  await new Promise((res, rej) => {
    sftp.fastPut('src/app/result/page.js', '/tmp/saju_runtime_frontend/src/app/result/page.js', err => err ? rej(err) : res());
  });

  console.log('Rebuilding runtime app with exact 3-stage floating bar sequence...');
  ...
  console.log('3-STAGE FLOATING BAR DEPLOY OUTPUT:\n', out);
...
deployExact3StageFloatingBars().catch(err => console.error('ERROR:', err));
