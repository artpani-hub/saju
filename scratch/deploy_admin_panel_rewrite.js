...
async function deployAdminPanelRewrite() {
  ...
  // Create directory /home/www/saju-artpani/frontend/src/app/admin_panel
...
deployAdminPanelRewrite().catch(err => console.error('ERROR:', err));
