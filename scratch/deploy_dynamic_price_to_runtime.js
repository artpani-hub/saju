...
async function deployDynamicPriceToRuntime() {
  ...
  console.log('SFTP Uploading updated src/app/input/page.js with dynamic DB price support...');
  
  await new Promise((res, rej) => {
    sftp.fastPut('src/app/input/page.js', '/tmp/saju_runtime_frontend/src/app/input/page.js', err => err ? rej(err) : res());
  });

  console.log('Rebuilding runtime environment...');
  ...
  console.log('DYNAMIC PRICE DEPLOY OUTPUT:\n', out);
...
deployDynamicPriceToRuntime().catch(err => console.error('ERROR:', err));
