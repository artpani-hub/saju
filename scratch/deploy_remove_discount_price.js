...
async function deployRemoveDiscountPrice() {
  ...
  console.log('SFTP Uploading updated src/app/api/admin/products/route.js without discountPrice field...');
  ...
  console.log('Rebuilding runtime app without discountPrice field...');
  ...
  console.log('REMOVE DISCOUNT PRICE REBUILD OUTPUT:\n', out);
...
deployRemoveDiscountPrice().catch(err => console.error('ERROR:', err));
