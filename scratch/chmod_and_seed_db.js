...
async function chmodAndSeedDb() {
  ...
  console.log('Chmodding dev.db and running seeding script...');

  const script = `
    chmod 777 /home/www/saju-artpani/frontend/prisma 2>/dev/null || true
    ...
    NODE_PATH=/home/www/saju-artpani/frontend/node_modules node -e "
      ...
      async function seed() {
        ...
        console.log('FINAL SEEDED PRODUCT COUNT:', finalCount);
      }
...
chmodAndSeedDb().catch(err => console.error('ERROR:', err));
