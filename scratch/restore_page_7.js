...
const oldCase = `      case "ny_ilju_harmony":
...
const index = content.indexOf(oldCase);
if (index === -1) {
  console.error("ny_ilju_harmony old case not found!");
  process.exit(1);
}
