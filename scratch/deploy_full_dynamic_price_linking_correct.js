...
async function deployFullDynamicPriceLinkingCorrect() {
  ...
  console.log('Creating directories on runtime...');
  await execCmd(conn, 'mkdir -p /tmp/saju_runtime_frontend/src/app/api/products');
...
deployFullDynamicPriceLinkingCorrect().catch(err => console.error('ERROR:', err));
