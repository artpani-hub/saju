...
// 1. insert the new cases before final_blessing
content = content.substring(0, insertIndex) + newCases + content.substring(insertIndex);

// 2. We also need to replace the getNewYearPagesConfiguration function to return the 51 pages
...
const newConfig = `  const getNewYearPagesConfiguration = (name, partnerName) => {
    return [
...
content = content.substring(0, configStartIndex) + newConfig + content.substring(configEndIndex);

fs.writeFileSync(filePath, content, 'utf-8');
console.log("Extend script finished successfully!");
