...
conn.on('ready', () => {
  console.log('Restoring working original .next directory...');

  const cmd = `
    node -e "
      const { execSync } = require('child_process');
      try {
        execSync('rm -rf /tmp/working_next && cp -rf /home/www/artpani/backups/real_saju_backup_20260831104251/src_bak /tmp/working_next', { stdio: 'inherit' });
      } catch (e) {}
    "
