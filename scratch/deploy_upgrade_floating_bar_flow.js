...
async function deployUpgradeFloatingBarFlow() {
  ...
  console.log('SFTP Uploading updated src/app/result/page.js with dynamic upgrade floating bar after 14,900 KRW payment...');

  await new Promise((res, rej) => {
    sftp.fastPut('src/app/result/page.js', '/tmp/saju_runtime_frontend/src/app/result/page.js', err => err ? rej(err) : res());
  });

  console.log('Rebuilding runtime app with upgrade floating bar flow...');
  ...
  console.log('UPGRADE FLOATING BAR FLOW DEPLOY OUTPUT:\n', out);
...
deployUpgradeFloatingBarFlow().catch(err => console.error('ERROR:', err));
