...
async function deployForceCleanBuild() {
  ...
  console.log('Moving old .next folder and building cleanly...');

  const script = `
    cd /home/www/saju-artpani/frontend &&
    
    # Move old .next if present
  ...
  console.log('FORCE CLEAN BUILD OUTPUT:\n', out);
...
deployForceCleanBuild().catch(err => console.error('ERROR:', err));
