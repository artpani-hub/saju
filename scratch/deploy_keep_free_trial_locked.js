...
async function deployKeepFreeTrialLocked() {
  ...
  console.log('SFTP Uploading updated src/app/result/page.js keeping free trial locked until 14900 payment...');

  await new Promise((res, rej) => {
    sftp.fastPut('src/app/result/page.js', '/tmp/saju_runtime_frontend/src/app/result/page.js', err => err ? rej(err) : res());
  });

  console.log('Rebuilding runtime app keeping free trial blur locked...');
  ...
  console.log('FREE TRIAL LOCK DEPLOY OUTPUT:\n', out);
...
deployKeepFreeTrialLocked().catch(err => console.error('ERROR:', err));
